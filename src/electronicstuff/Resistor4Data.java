...
/**
 * created by Marcelino on 16/10/2017 at 21:44
 */

public final class Resistor4Data {
    ...
    private static Resistor4Data instance = new Resistor4Data();


    /** ------------ GETS E SETS ------------ */
    public static Resistor4Data getInstance() {
        return instance;
    }
    ...
    public void armazenarResistor (ObservableList<Componente> listaResistores, String pot, int qtd, String material) {
        ...
        Resistor novoResistor = new Resistor(getResistencia(), material, getTol(), pot, qtd, getCorFaixa1(),
                getCorFaixa2(), getCorFaixa3(), getCorFaixa4());
